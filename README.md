...
`gameR_colors` list in [R/discrete.R](R/discrete.R), adding the name of
the palette to `@param palette`, and calling `devtools::document()` from
R to update the package documentation.

### Updating the README

The readme is generated by [README.Rmd](README.Rmd). Please update this
file with the palettes you are contributing (the palettes are in
...
to be recognised. Please feel free to add yourself as contributor (role
= “ctb”) in the [DESCRIPTION](DESCRIPTION) file.
