...
continuous palettes are provided via the
[`gameR_cols()`](https://www.constantine-cooke.com/gameR/reference/gameR_cols.md)
and
[`gameR_cont()`](https://www.constantine-cooke.com/gameR/reference/gameR_cont.md)
functions respectively. For a full list of the palettes provided by
